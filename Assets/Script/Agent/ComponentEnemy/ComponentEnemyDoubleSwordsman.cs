...
public class ComponentEnemyDoubleSwordsman : MonoBehaviour, IActionHandle
{
	Agent Owner;
    ...
    {        // Agent.AddGOAPAction(E_GOAPAction.E_GOTO);
        ...
        Agent.AddAction(E_GOAPAction.attackMeleeTwoSwords);
        Agent.AddAction(E_GOAPAction.attackWhirl);
